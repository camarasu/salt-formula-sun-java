...
{%- set default_source_url   = 'https://www.creatis.insa-lyon.fr/~camarasu/tp_cloud_2019/jdk-8u74-linux-x64.tar.gz' %}
{%- set default_jce_url      = 'https://www.creatis.insa-lyon.fr/~camarasu/tp_cloud_2019/jce_policy-8.zip' %}
